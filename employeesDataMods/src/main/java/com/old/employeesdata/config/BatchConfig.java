...
import com.old.employeesdata.processor.EmployeeProcessor;
import com.old.employeesdata.reader.EmployeeFilereader;
...
//		itemReader.setResource(new FileSystemResource(EmployeeUtilClass.fileLocation));
...
//	}
	...
	public Step masterStep() {
		return stepBuilderFactory
				.get(EmployeeUtilClass.masterStep)
	...
	public Step slaveStep() {
		return stepBuilderFactory
				.get(EmployeeUtilClass.slaveStep)
